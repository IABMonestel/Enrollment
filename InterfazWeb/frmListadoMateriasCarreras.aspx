<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="frmListadoMateriasCarreras.aspx.cs" Inherits="InterfazWeb.frmListadoMateriasCarreras" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <asp:GridView ID="grdLista" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No se registran estudiantes" ForeColor="#333333" GridLines="None" Width="100%" OnPageIndexChanging="GrdLista_PageIndexChanging" PageSize="15">
            ...
            <Columns>                
                ...
                <asp:BoundField DataField="Corequisite" HeaderText="Correquisito" />
